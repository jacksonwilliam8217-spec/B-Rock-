...
const planName = Array.isArray(investment.investment_plans)
  ? investment.investment_plans[0]?.name || "Investment Plan"
  : "Investment Plan";
  ...
  const notificationMessage = `Your ${planName || "investment"} has completed successfully. Investment amount: $${amount.toFixed(2)}. Calculated profit: $${profit.toFixed(2)}.`;
  ...
  if (appNotificationError) {
    console.error("Investment completion notification error:", appNotificationError);
  }
    ...
    const { error: emailError } = await resend.emails.send({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;line-height:1.6;color:#172033;">
          ...
          <p>
            We encourage you to review your portfolio and consider
            diversification carefully before making your next investment decision.
          </p>
